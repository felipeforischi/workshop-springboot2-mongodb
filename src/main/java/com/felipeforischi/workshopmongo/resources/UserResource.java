package com.felipeforischi.workshopmongo.resources;
...
public class UserResource {
	...
	//@PostMapping-> pode ser usado no lugar de @RequestMapping(method=RequestMethod.POST)
	...
	//@PutMapping-> pode ser usado no lugar de @RequestMapping(method=RequestMethod.PUT)
